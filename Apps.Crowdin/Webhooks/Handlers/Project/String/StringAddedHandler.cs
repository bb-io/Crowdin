...
public class StringAddedHandler(InvocationContext invocationContext, [WebhookParameter(true)] ProjectWebhookInput input) : ProjectBridgeWebhookHandler(invocationContext, input, true)
{
